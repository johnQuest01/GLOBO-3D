...
const LockControl: React.FC<LockControlProps> = ({
  ...
  <button
    ...
    className={`absolute bottom-24 right-4 sm:bottom-4 z-[60] p-3 rounded-full text-white bg-white/10 hover:bg-white/20 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-white ${className}`}
  >
